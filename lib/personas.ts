...
export const PERSONA_DEFINITIONS: PersonaDefinition[] = [
  ...
  },
  {
    ...
    seniority: 'C-Suite',
    painPoints: [
      'Strategic Challenges: balancing service reliability with cost efficiency',
      'Strategic Challenges: limited ability to standardize procurement processes across geographies',
      'Strategic Challenges: aligning freight procurement with broader supply chain strategy',
      'Operational Pain Points: manual, siloed carrier selection and tendering processes',
      'Operational Pain Points: inconsistent freight procurement practices across business units',
      'Operational Pain Points: strain on operational teams to respond to capacity shifts and disruptions',
      'Cost & Budget Concerns: difficulty managing operational costs with volatile freight rates',
      'Cost & Budget Concerns: lack of transparency into total landed costs',
      'Cost & Budget Concerns: over-reliance on spot markets during crunches, driving up operating expenses',
      'Risk & Compliance: vulnerability to port congestion, weather disruptions, or strikes',
      'Risk & Compliance: carrier insolvency threatening delivery commitments',
      'Risk & Compliance: lack of standardized vetting for new carrier partners',
      'Technology & Data Gaps: lack of integration between procurement, logistics, and operations systems',
      'Technology & Data Gaps: poor data quality limiting ability to forecast demand vs. capacity',
      'Technology & Data Gaps: resistance from operations teams to adopt new procurement tech',
      'Carrier & Supplier Management: maintaining strong operational ties with carriers under cost pressure',
      'Carrier & Supplier Management: inconsistent visibility into service levels across modes and regions',
      'Carrier & Supplier Management: difficulty enforcing performance accountability with carriers',
      'Talent & Organizational Pressures: scarcity of operations leaders skilled in digital freight procurement',
      'Talent & Organizational Pressures: pressure to deliver operational savings and service improvements simultaneously',
      'Talent & Organizational Pressures: burnout among supply chain staff due to constant firefighting'
    ],
  ...
  },
  {
    ...
    seniority: 'C-Suite',
    painPoints: [
      'Strategic Challenges: balancing cost optimization with service reliability and shareholder expectations',
      'Strategic Challenges: difficulty forecasting freight budgets with accuracy due to rate volatility',
      'Strategic Challenges: ensuring freight procurement aligns with broader cost-containment strategies',
      'Operational Pain Points: high administrative overhead in tracking freight invoices and settlements',
      'Operational Pain Points: manual reconciliation processes prone to errors',
      'Operational Pain Points: inability to track savings initiatives effectively',
      'Cost & Budget Concerns: volatile freight rates disrupting financial planning',
      'Cost & Budget Concerns: limited benchmarking data for evaluating carrier competitiveness',
      'Cost & Budget Concerns: inconsistent reporting of procurement-driven savings to stakeholders',
      'Risk & Compliance: exposure to compliance risks in global freight agreements',
      'Risk & Compliance: unclear auditing trails for freight spend',
      'Risk & Compliance: financial risks from carrier underperformance or bankruptcy',
      'Technology & Data Gaps: disconnected systems between finance, procurement, and transportation',
      'Technology & Data Gaps: lack of unified reporting across carriers and geographies',
      'Technology & Data Gaps: difficulty scaling digital procurement solutions across finance teams',
      'Carrier & Supplier Management: tension between cost-driven negotiations and maintaining carrier loyalty',
      'Carrier & Supplier Management: limited transparency into long-term carrier financial stability',
      'Carrier & Supplier Management: struggles with enforcing fair contract terms during market swings',
      'Talent & Organizational Pressures: lack of finance talent with freight procurement domain expertise',
      'Talent & Organizational Pressures: pressure to validate ROI on procurement technology investments',
      'Talent & Organizational Pressures: growing executive demand for detailed freight spend analytics'
    ],
