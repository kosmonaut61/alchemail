...
export const PERSONA_DEFINITIONS: PersonaDefinition[] = [
  ...
  },
  {
    ...
    painPoints: [
      ...
      'Operational Inefficiencies: reliance on outdated ERP/financial systems that require manual data entry and verification',
  ...
  // Finance Department
  {
    ...
    painPoints: [
      ...
      'Freight Audit & Payment Challenges: manual invoice checking leading to errors and delays',
