...
39. GIFT CARD LANGUAGE: If mentioning gift card incentives, ALWAYS use "up to $X" language - never promise the full amount. Example: "up to $500 gift card" not "$500 gift card". Also do not imply the giftcard is for having a conversation. The gift card is applicable to a demo. Do not reference a specfic amount of time required to participate in a demo to be eligible. Keep the giftcard as a secondary thought in the call to action. We are primarily trying to have an initial conversation to see if they are elgible for a demo and giftcard.
